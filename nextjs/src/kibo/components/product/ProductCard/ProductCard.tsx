...
import { usePriceRangeFormatter } from "@/hooks/custom/usePriceRangeFormatter/usePriceRangeFormatter";
    ...
    const handleAddToCart = (event: any) => {
        ...
        const payload = {
            product: {
                ...
                fulfillmentMethod: fulfillmentTypesSupported?.includes(
        ...
        return (
            <Box sx={ProductCardStyles.main}>
                <Link href={link} passHref data-testid="product-card-link">
                    <Box>
                        <Card
                            sx={{ ...ProductCardStyles.cardRoot, minHeight: 321 }}
                        ...
                        >
                            ...
                            <Box flexDirection="column" m={1}>
                                ...
                                <Rating
                                    ...
                                    size="small"
                                    icon={
                                        <StarRounded color="primary" data-testid="filled-rating" />
                                    }
