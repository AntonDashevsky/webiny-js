import {
    type IRecordLockingIsEntryLocked,
    type IRecordLockingIsEntryLockedParams,
    type IRecordLockingIsEntryLockedResult
...
import {
    type IRecordLockingIsEntryLockedResponse,
    type IRecordLockingIsEntryLockedVariables,
