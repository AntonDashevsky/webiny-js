import { type FbFormRenderComponentProps, type FormSubmitResponseType } from "~/types.js";

import {
    CREATE_FORM_SUBMISSION,
    type CreateFormSubmissionMutationResponse,
    type CreateFormSubmissionMutationVariables
} from "./graphql.js";
