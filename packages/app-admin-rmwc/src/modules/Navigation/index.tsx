        ...
        return (
            <div>
                <Sidebar
                    ...
                    icon={
                        <Sidebar.Icon
                            element={<img src={wbyLogo} alt={"Webiny"} />}
                            label={"Webiny"}
                        />
                    }
                >
                    ...
                    <Sidebar.Item
                        icon={
                            <Sidebar.Item.Icon label="Form Builder" element={<FormBuilderIcon />} />
                        }
                    ...
                    <Sidebar.Item
                        icon={
                            <Sidebar.Item.Icon label="Page Builder" element={<PageBuilderIcon />} />
                        }
                    ...
                    <Sidebar.Item
                        icon={
                            <Sidebar.Item.Icon label="Publishing Workflows" element={<ApwIcon />} />
                        }
