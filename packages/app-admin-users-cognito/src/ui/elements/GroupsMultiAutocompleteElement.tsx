...
export class GroupsMultiAutocompleteElement extends InputElement {
    public override render(
        this: GroupsMultiAutocompleteElement,
        ...
        if (validators && typeof validators !== "function") {
            console.log(
                "packages/app-admin-users-cognito/src/ui/elements/GroupsMultiAutocompleteElement.tsx validators is set but not a function."
            );
        ...
        return (
            ...
            >
                <GroupsMultiAutocomplete label={"Roles"} data-testid="groups-autocomplete" />
            </Bind>
        );
    }
}
