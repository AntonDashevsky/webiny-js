...
export interface AccordionFooterProps extends React.HTMLAttributes<HTMLDivElement> {
    actions?: React.ReactNode;
    info?: React.ReactNode;
}

export const AccordionFooter = ({ actions, info, className, ...props }: AccordionFooterProps) => {
    if (!actions && !info) {
        return null;
    }
