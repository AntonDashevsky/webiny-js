...
const HeaderBarExample = () => {
    ...
    const EndContent = () => (
        <div className={"wby-flex wby-gap-x-sm"}>
            ...
            <div
                className={
                    "wby-flex wby-items-center wby-rounded-md " +
"wby-gap-xxs wby-py-xs wby-px-xs wby-bg-neutral-light"
                }
            >
                <Avatar
                    size={"sm"}
...
const EndContentOnlyExample = () => {
    const EndContent = () => (
        <div className={"wby-flex wby-gap-x-sm"}>
            ...
            <div
                className={
                    "wby-flex wby-items-center wby-rounded-md wby-gap-xxs
                    wby-py-xs wby-px-xs wby-bg-neutral-light"
                }
            >
                <Avatar
                    size={"sm"}
