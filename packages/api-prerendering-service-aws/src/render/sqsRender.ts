import plugin, { RenderParams } from "@webiny/api-prerendering-service/render/index.js";
import { createSQSEventHandler } from "@webiny/handler-aws";
import { HandlerPayload } from "@webiny/api-prerendering-service/render/types.js";
