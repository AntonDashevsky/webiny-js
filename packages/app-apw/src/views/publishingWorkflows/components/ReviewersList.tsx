...
import type { ChildrenRenderProp } from "@webiny/ui/Checkbox/CheckboxGroup";
...
const ListItemTitle = ({ index, label }: ListItemTitleProps) => {
    return (
...
export const ReviewersList = ({ onChange, getValue }: ChildrenRenderProp) => {
